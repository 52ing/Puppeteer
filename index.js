...
(async () => {
  ...
  log('test_1 \ 로그인 화면 진입 성공2222222222222222')
  await delay(1000)
  var checkResult = await page.evaluate('');
  log(checkResult)
  rows.push(['1','로그인 화면 진입 성공', checkResult])
  await delay(1000)
  ...
  // log(checkResult)
  // rows.push(['6','전체보기 선택 active', checkResult])
  // await delay(1000)
