...
(async () => {
  ...
  log('test_1 \ 로그인 화면 진입 성공111111111111111111')
  await delay(1000)
  ...
  await type('//*[@id="adminEmail"]', 'seul.lee@wirebarley.com');
  await page.screenshot({path: '2.jpg'});
  log('test_2 \ 계정입력');
  await delay(1000)
  var checkResult = await page.evaluate('');
  ...
  await type('/html/body/div[1]/div/div[2]/div[1]/form/div[1]/div[2]/div/input', 'dltmfrls1!A');
